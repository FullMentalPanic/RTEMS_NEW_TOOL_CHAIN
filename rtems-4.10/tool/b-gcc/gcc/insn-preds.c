/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-4.4.7/gcc/config/sparc/sparc.md'.  */
...
const_zero_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 25 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(op == CONST0_RTX (mode));
}
...
const_one_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 30 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(op == CONST1_RTX (mode));
}
...
#line 35 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(INTVAL (op) == 4096));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 42 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(SPARC_SIMM13_P (INTVAL (op))));
}

static inline int
uns_small_int_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 49 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 68 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && ((!(small_int_operand (op, mode))) && (
#line 75 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(SPARC_SETHI_P (~INTVAL (op) & GET_MODE_MASK (mode)))));
}

static inline int
fp_const_high_losum_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 81 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 97 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 126 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 131 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 136 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 141 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
#line 149 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 162 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(GET_MODE (op) == mode))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 170 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF :
...
#line 189 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
  switch (GET_CODE (op))
    {
    case LABEL_REF :
...
#line 217 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
{
  return (
#line 225 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(register_operand (op, SImode))) || (
#line 226 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(TARGET_ARCH64 && register_operand (op, DImode)));
}

static inline int
fcc_register_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 231 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 250 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
  if (mode != VOIDmode && mode != GET_MODE (op))
    return false;
  if (mode == VOIDmode
...
#line 263 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 294 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 324 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 339 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
{
  return (register_operand (op, mode)) || ((GET_CODE (op) == CONST_INT) && (
#line 347 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
#line 360 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 379 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 423 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
#line 428 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
...
#line 437 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
...
#line 451 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
...
#line 450 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(TARGET_V9))) && (
...
#line 481 "../../gcc-4.4.7/gcc/config/sparc/predicates.md"
(REG_P (XEXP (op, 0)))));
}
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 66 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(SPARC_SIMM13_P (ival));

    case CONSTRAINT_J:
      return 
#line 71 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(ival == 0);

    case CONSTRAINT_K:
      return 
#line 76 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(SPARC_SETHI32_P (ival));

    case CONSTRAINT_L:
      return 
#line 81 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(SPARC_SIMM11_P (ival));

    case CONSTRAINT_M:
      return 
#line 86 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(SPARC_SIMM10_P (ival));

    case CONSTRAINT_N:
      return 
#line 91 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(SPARC_SETHI_P (ival));

    case CONSTRAINT_O:
      return 
#line 96 "../../gcc-4.4.7/gcc/config/sparc/constraints.md"
(ival == 4096);
